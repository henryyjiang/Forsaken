using UnityEngine;
public class EvaMoveToHideState : State
{
    private EvaStateMachine evaContext;
    public EvaMoveToHideState(EvaStateMachine currentContext) : base(currentContext)
    {
    ...
    public override void CheckSwitchStates()
    {
        ...
        if (distance < 0.1f)
        {
            SwitchState(new EvaHiddenState(evaContext));
        }
    }
